...
# Generate random 4-character suffix for cluster name
resource "random_string" "cluster_suffix" {
  ...
  keepers = {
    # Changing this will regenerate the suffix
    # Remove or change to force regeneration
    cluster_base = var.product
  }
}
