...
resource "aws_elasticache_parameter_group" "algoitny_redis_cluster_pg" {
  name        = "algoitny-cluster-${data.terraform_remote_state.vpc.outputs.shard_id}"
  description = "algoitny Elasticache Valkey Parameter Group"
