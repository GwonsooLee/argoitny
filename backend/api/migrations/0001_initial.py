        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "problem_identifier",
                    models.CharField(
                        help_text="Human-readable identifier (e.g., 1520E)",
                        max_length=255,
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status", "-created_at"], name="pej_status_created_idx"
                    ),
                    models.Index(
                        fields=["platform", "problem_id"],
                        name="pej_platform_problem_idx",
                    ),
